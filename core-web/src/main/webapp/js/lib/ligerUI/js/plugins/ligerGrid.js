            ...
            var ajaxOptions = {
                ...
                success: function (data)
                {
                	if(typeof data === "object") {
        				if(data.errorMsg) {
        					if($.ligerDialog) $.ligerDialog.error(data.errorMsg);
            ...
            else if (src.detailbtn && p.detail)
            {
                ...
                else
                {
                   ...
                   // console.info("end >>>>>> ");
                    ...
                    var srcrowId = $(src.row).attr("id").replace(/[|]\d{1,2}[|]/g,"|1|");
                	var $forzonRow = $("tr[id='"+ srcrowId+"']",g.gridview1);
                    $forzonRow.next("tr.l-grid-detailpanel").find(".l-grid-detailpanel-inner:first").height(detailRowInner.height());
