...
(function($) {
	...
	function _92(_93, _94) {
		...
		_9a = _9a.replace(/{from}/, _96.total == 0 ? 0 : _96.pageSize
				* (_96.pageNumber - 1) + 1);
		//console.info(JSON.stringify(_96));
					...
					$.fn.panel.defaults,
					{
						...
						loader : function(_70c, _70d, _70e) {
							...
							$.ajax({
								...
								dataType : "json",
								success : function(data) {
									if(data.list) data.rows = data.list;
									if(data.allRow)data.total = data.allRow;
									if(data.pageNo)data.pageNumber = data.pageNo;
									_70d(data);
								},
								error : function() {
...
(function($) {
	...
	// flag TODO easyui - combobox
	$.fn.combobox.parseOptions = function(_8d7) {
		var t = $(_8d7);
		var options = $.extend({}, $.fn.combo.parseOptions(_8d7), $.parser.parseOptions(_8d7, [ "valueField", "textField", "groupField","mode", "method", "url" ]));
		//console.info(JSON.stringify(options));
		if(!options.editable) options.editable = false;
		return options;
	};
