  ...
  <head>
   ...
   <script type="text/javascript"> 	
        ...
        function saveRoles(){
        	...
        	$.myAjax({
  				type : 'POST',
  				url : '${ctx}/system/userInfoRoles/updateURMapping.do',
  				dataType : 'json',
  				data : {
   ...
   <body style="background-color: #F4FBF4;padding: 10px;">
  	 <span style="font-size:12pt;font-weight: normal;padding: 5px auto;">当前操作  >> 分配角色  >> 用户名称  [&nbsp;<span style="font-weight: bolder;">${user.username }</span>&nbsp;]</span>
	 <div style="padding: 10px;width: 80%;margin: auto;">
	  	 <div style="margin:4px;float:left;">
	  	 	 <div>用户[&nbsp;<span style="font-weight: bolder;">${user.username }</span>&nbsp;]的角色</div>
	   ...
	   <!--        <input type="button" onclick="moveToRight()" value="&rarr;" />
	          <input type="button" onclick="moveAllToLeft()" value="&lArr;" />
	         <input type="button" onclick="moveAllToRight()" value="&rArr;" /> -->
	     </div>
	     <div style="margin:4px;float:left;">
	     	<div>系统有效角色</div>
	 ...
	 <div style="clear: both;color: red;padding-left: 15px;">PS:点击保存按扭后，相应操作才生效!</div>
