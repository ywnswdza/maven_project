...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
   ...
   <body style="background-color: #F4FBF4;padding: 10px;">
  	  <form name="form1" method="post"  id="form1" action="${ctx }/system/attachment/save.do">
   	  		<input type="hidden" id="input_id" name="id" value="${vo.id}">
	        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
	        	<tr>
	                <td align="right" class="l-table-edit-td">文件名:</td>
	                <td align="left" class="l-table-edit-td" style="width:160px" >
	                		<input value="${vo.fileRealName}" name="fileRealName" id="input_fileRealName" ltype="text" validate="{required:false,maxlength:100,notnull:false}" nullText="不能为空!"/>
	                </td>
	        	...
	        	<tr>              
	                ...
	                <td align="left" class="l-table-edit-td" style="width:160px" >
	                		<input value="${vo.groupId}" name="groupId" id="input_groupId" ltype="text" validate="{required:false,maxlength:100,notnull:false}" nullText="不能为空!"/>
	                </td>
	                <td class="l-table-edit-td" width="20"></td>	              
	            </tr>
	      	</table>
